...
const delete_journal_table_sql = "DELETE FROM journal;"

db.execute(delete_journal_table_sql);

/**** Create some sample journal entries and dreams ****/

const insert_journal_sql = `
    INSERT INTO journal 
        (journalID, dreamDate, dreamName, dreamType) 
    VALUES 
        (?, ?, ?, ?);
`
